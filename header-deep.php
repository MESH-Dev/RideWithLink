		...
		<header>
				...
				<div class="twelve columns">
					...
					<nav class="main-navigation animated bounceInDown">
						<ul>
							...
							<li><a class="why-link" href="<?php echo esc_url( home_url( '/#why' ) ); ?>">Why Link</a></li>
							
							<li><a class="how-link" href="<?php echo esc_url( home_url( '/#how' ) ); ?>">How it Works</a></li>
							
							<li><a class="where-link" href="<?php echo esc_url( home_url( '/#where' ) ); ?>">Link up in your City</a></li>
							
							<li><a class="contact-link" href="<?php echo esc_url( home_url( '/#contact' ) ); ?>">Contact</a></li>
							<li class="social">
			...
			<div class="ribbon animated slideInRight">
				<div class="ribbon-title go-partner">
					<a href="<?php echo esc_url( home_url( '/#partner' ) ); ?>"><span>Become a partner</span></a>
				</div>
				<div class="ribbon-title go-driver">
					<a href="<?php echo esc_url( home_url( '/#driver' ) ); ?>"><span>Become a driver</span>
				</div>
			</div>
